...
contract NetCafeTopUpV2 is OwnableUpgradeable, UUPSUpgradeable, NetCafeStaffUpgradeable {
    enum PaymentMethod {
        CASH,
        BANK
    }
    ...
    function initialize(address _staffContract, address _userContract) public initializer {
    ...
    function getTopUpHistory(address wallet) external view returns (uint256[] memory) {
